                        ...
                        <table class="table" ui-jq="footable" ui-options='{
                            ...
                            <c:forEach var="signalement" items="${signalements}">
                                <tr>
                                    ...
                                    <td><a href="<%= request.getContextPath()%>/admin/affecter/${signalement.id}"
                                           type="button" class="btn btn-primary">Affecter</a></td>
                                    <td>
                                        <a href="<%= request.getContextPath()%>/admin/seeMore/${signalement.idclient}/${signalement.id}"
